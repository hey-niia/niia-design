...
export const experience: Role[] = [
  ...
  },
  {
    ...
    period: "2016–2022",
    description:
      "I founded Leap, a health snack brand that reached 1000+ shops and cafés across Ukraine. Sole founder: product and packaging design, manufacturing, distribution, social, and the team I hired to run it. That generalist range is still what startups hire me for.",
  },
];
